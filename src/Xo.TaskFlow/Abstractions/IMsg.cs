...
public interface IMsg
{
	...
	/// </summary>
	/// <remarks>
	///   This is used by the <see cref="IFunctitect" />, where reflection is used to dynamically create a functory factory from a <see cref="System.Type" /> that is provided.
	/// </remarks>
